...
get_ipython().system('python -m spacy download de # one time run')
...
def cleantext(df):
    ...
    df['text'] = df['text'].str.replace("buch", " ")
    
    df['text'] = df['text'].str.replace("autor" , " ")
    
    df['text'] = df['text'].str.replace("geschichte" , " ")
        
    df['text'] = df['text'].str.replace("ullstein" , " ")
    
    df['text'] = df['text'].str.replace("buchverlage" , " ")
    
    df['text'] = df['text'].str.replace("aufbau" , " ")
    
    df['text'] = df['text'].str.replace("verlag" , " ")
    
    df['text'] = df['text'].str.replace("bestie" , " ")
